...
namespace MemoryUtils {
	...
	/// </summary>
	bool EncodeToHexA(unsigned char* pData, size_t unSize, char* szData, const bool bUseUpperCase = true);

	/// <summary>
	/// Encode the data array to a hexadecimal string.
	/// </summary>
	bool EncodeToHexW(void* pData, size_t unSize, wchar_t* szData, const bool bUseUpperCase = true);

#ifdef UNICODE
	/// <summary>
	/// Encode the data array to a hexadecimal string.
	/// </summary>
	bool EncodeToHex(void* pData, size_t unSize, wchar_t* szData, const bool bUseUpperCase = true);
#else
	/// <summary>
	/// Encode the data array to a hexadecimal string.
	/// </summary>
	bool EncodeToHex(void* pData, size_t unSize, char* szData, const bool bUseUpperCase = true);
#endif
